...
class syllogisms():
        ...
        def celarent(self,s,m,p):
            question = "All " + str(self.plur(s))+" are " + str(self.plur(m)) +", no " +str(m) +" is " + str(p)
            answer = "No " + str(s)+" is " + str(p)
            return question,answer,3
        
        def cesare(self,s,m,p):
            question = "All " + str(self.plur(s))+" are " + str(self.plur(m)) +", no " +str(p) +" is " + str(m)
            answer = "No " + str(s)+" is " + str(p)
            return question,answer,3
        
        def calemes(self,s,m,p):
            question = "No " + str(m)+" is " + str(s) +", all " +str(self.plur(p)) +" are " + str(self.plur(m))
            answer = "No " + str(s)+" is " + str(p)
            return question,answer,3
        
        def camestres(self,s,m,p):
            question = "No " + str(s)+" is " + str(m) +", all " +str(self.plur(p)) +" are " + str(self.plur(m))
            answer = "No " + str(s)+" is " + str(p)
            return question,answer,3
        
        def darii(self,s,m,p):
            question = "Some " + str(self.plur(s))+" are " + str(self.plur(m)) +", all " +str(self.plur(m)) +" are " + str(self.plur(p))
            answer = "Some " + str(self.plur(s))+" are " + str(self.plur(p))
            return question,answer,2
        
        def datisi(self,s,m,p):
            question = "Some " + str(self.plur(m))+" are " + str(self.plur(s)) +", all " +str(self.plur(m)) +" are " + str(self.plur(p))
            answer = "Some " + str(self.plur(s))+" are " + str(self.plur(p))
            return question,answer,2
        
        def darapti(self,s,m,p):
            question = "All " + str(self.plur(m))+" are " + str(self.plur(s)) +", all " +str(self.plur(m)) +" are " + str(self.plur(p))
            answer = "Some " + str(self.plur(s))+" are " + str(self.plur(p))
            return question,answer,2
        
        def disamis(self,s,m,p):
            question = "All " + str(self.plur(m))+" are " + str(self.plur(s)) +", some " +str(m) +" are " + str(self.plur(p))
            answer = "Some " + str(self.plur(s))+" are " + str(self.plur(p))
            return question,answer,2
        
        def dimatis(self,s,m,p):
            question = "All " + str(self.plur(m))+" are " + str(self.plur(s)) +", some " +str(p) +" are " + str(self.plur(m))
            answer = "Some " + str(self.plur(s))+" are " + str(self.plur(p))
            return question,answer,2
        
        def baroco(self,s,m,p):
            question = "Some " + str(self.plur(s))+" are not " + str(m) +", all " +str(self.plur(p)) +" is " + str(m)
        ...
        def bocardo(self,s,m,p):
            question = "All " + str(self.plur(m))+" are " + str(self.plur(s)) +", some " +str(m) +" are not " + str(self.plur(p))
            answer = "Some " + str(self.plur(s))+" are not " + str(self.plur(p))
            return question,answer,4
        
        def bamalip(self,s,m,p):
            question = "All " + str(self.plur(m))+" are " + str(self.plur(s)) +", all " +str(self.plur(p)) +" are " + str(self.plur(m))
            answer = "Some " + str(self.plur(s))+" are " + str(self.plur(p))
            return question,answer,2
        
        def ferio(self,s,m,p):
            question = "Some " + str(self.plur(s))+" are " + str(self.plur(m)) +", no " +str(m) +" is " + str(p)
            answer = "Some " + str(self.plur(s))+" are not " + str(self.plur(p))
            return question,answer,4
        
        
        def festino(self,s,m,p):
            question = "Some " + str(self.plur(s))+" are " + str(self.plur(m)) +", no " +str(p) +" is " + str(m)
            answer = "Some " + str(self.plur(s))+" are not " + str(self.plur(p))
            return question,answer,4
        
        def ferison(self,s,m,p):
            question = "Some " + str(self.plur(m))+" are " + str(self.plur(s)) +", no " +str(m) +" is " + str(p)
            answer = "Some " + str(self.plur(s))+" are not " + str(self.plur(p))
            return question,answer,4
        
        def fresison(self,s,m,p):
            question = "Some " + str(self.plur(m))+" are " + str(self.plur(s)) +", no " +str(p) +" is " + str(m)
            answer = "Some " + str(self.plur(s))+" are not " + str(self.plur(p))
            return question,answer,4
        
        def felapton(self,s,m,p):
            question = "All " + str(self.plur(m))+" are " + str(self.plur(s)) +", no " +str(m) +" is " + str(p)
            answer = "Some " + str(self.plur(s))+" are not " + str(self.plur(p))
            return question,answer,4
        
        def fesapo(self,s,m,p):
            question = "All " + str(self.plur(m))+" are " + str(self.plur(s)) +", no " +str(p) +" is " + str(m)
            answer = "Some " + str(self.plur(s))+" are not " + str(self.plur(p))
            return question,answer,4
        ...
        def gen_question(self,num):
            functions = [self.barbara,self.barbari,self.celarent,self.cesare,self.calemes,
                        ...
                        self.calemos,self.bocardo,self.bamalip,self.ferio,
                        self.festino,self.ferison,self.fresison,self.felapton,
                        self.fesapo]
        ...
        def answer_corruptor(self,det,s,m,p):
            ...
            if(det!=2):
                three_bad_an.append("Some " + str(self.plur(s))+" are " + str(self.plur(p)))
            if(det!=3):
                three_bad_an.append("No " + str(s)+" is " + str(p))
            if(det!=4):
                three_bad_an.append("Some " + str(self.plur(s))+" are not " + str(self.plur(p)))
            return (three_bad_an)
